# Implements a proleptic Gregorian calendar date as Julian day number
...
class Date:
    ...
    def __init__(self, month, day, year):
        ...
        # since Python's implementation of integer division is nt the same
    ...
    # Returns day of week as an int between 0 (Mon) and 6 (Sun).
    def dayOfWeek(self):
    ...
    # The remaining methods are to b included at this point.
    # ....
